...
/**
 * @brief  4 DualShock4 are supported simultaneously to work with
 */
typedef enum
{
	TM_USB_HIDDEVICE_DS4_Number_1 = 0x01, /*!< Send data to computer for game pad 1 */
	TM_USB_HIDDEVICE_DS4_Number_2 = 0x02, /*!< Send data to computer for game pad 2 */
	TM_USB_HIDDEVICE_DS4_Number_3 = 0x03, /*!< Send data to computer for game pad 1 */
	TM_USB_HIDDEVICE_DS4_Number_4 = 0x04  /*!< Send data to computer for game pad 2 */
} TM_USB_HIDDEVICE_DS4_Number_t;
...
/**
 * @brief  Dual Shock4 structure for 4 game pads available
 */
typedef struct
{
	TM_USB_HIDDEVICE_Button_t Triangle;	 /*!< Game pad button 1 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t circle;	 /*!< Game pad button 2 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t cross;	 /*!< Game pad button 3 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t rectangle; /*!< Game pad button 4 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t R3;		 /*!< Game pad button 5 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t L3;		 /*!< Game pad button 6 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t option;	 /*!< Game pad button 7 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t start;	 /*!< Game pad button 8 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t R2;		 /*!< Game pad button 9 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t L2;		 /*!< Game pad button 10 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	TM_USB_HIDDEVICE_Button_t R1;		 /*!< Game pad button 11 status. This parameter can be a value of @ref TM_USB_HIDDEVICE_Button_t enumeration */
	...
	uint8_t RightXAxis; /*!< Right joystick X axis */
	uint8_t RightYAxis; /*!< Right joystick Y axis */
	uint8_t R2Trigger;	/*!< R2 */
	uint8_t L2Trigger;	/*!< L2 */
	...
	uint8_t bitmask; /*EXT/HeadSet/Earset: bitmask
 ...
 * @retval Member of @ref TM_USB_HIDDEVICE_Status_t enumeration
 */
TM_USB_HIDDEVICE_Status_t TM_USB_HIDEVICE_DualShock4_StructInit(TM_USB_HIDDEVICE_DualShock4_t *Gamepad_Data);
 ...
 * @retval Member of @ref TM_USB_HIDDEVICE_Status_t enumeration
 */
TM_USB_HIDDEVICE_Status_t TM_USB_HIDDEVICE_DualShock4_Send(TM_USB_HIDDEVICE_DS4_Number_t gamepad_id, TM_USB_HIDDEVICE_DualShock4_t *Gamepad_Data);
